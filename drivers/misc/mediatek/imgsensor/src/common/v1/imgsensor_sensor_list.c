...
#if defined(IRONMAN_QUNHUI_HI1336_MIPI_RAW)
                {IRONMAN_QUNHUI_HI1336_SENSOR_ID,
                SENSOR_DRVNAME_IRONMAN_QUNHUI_HI1336_MIPI_RAW,
                IRONMAN_QUNHUI_HI1336_MIPI_RAW_SensorInit},
#endif

#if defined(IRONMAN_DONGCI_HI1336_MIPI_RAW)
			{IRONMAN_DONGCI_HI1336_SENSOR_ID,
			SENSOR_DRVNAME_IRONMAN_DONGCI_HI1336_MIPI_RAW,
			IRONMAN_DONGCI_HI1336_MIPI_RAW_SensorInit},
#endif

#if defined(IRONMAN_LIANYI_GC5035_MIPI_RAW)
		{IRONMAN_LIANYI_GC5035_SENSOR_ID,
		SENSOR_DRVNAME_IRONMAN_LIANYI_GC5035_MIPI_RAW,
		IRONMAN_LIANYI_GC5035_MIPI_RAW_SensorInit},
#endif

#if defined(IRONMAN_QUNHUI_GC5035_MIPI_RAW)
			{IRONMAN_QUNHUI_GC5035_SENSOR_ID,
			SENSOR_DRVNAME_IRONMAN_QUNHUI_GC5035_MIPI_RAW,
			IRONMAN_QUNHUI_GC5035_MIPI_RAW_SensorInit},
#endif

#if defined(IRONMAN_CXT_GC2375H_MIPI_RAW)
			{IRONMAN_CXT_GC2375H_SENSOR_ID,
			SENSOR_DRVNAME_IRONMAN_CXT_GC2375H_MIPI_RAW,
			IRONMAN_CXT_GC2375H_MIPI_RAW_SensorInit},
#endif

#if defined(IRONMAN_LH_GC2375H_MIPI_RAW)
			{IRONMAN_LH_GC2375H_SENSOR_ID,
			SENSOR_DRVNAME_IRONMAN_LH_GC2375H_MIPI_RAW,
			IRONMAN_LH_GC2375H_MIPI_RAW_SensorInit},
#endif

//+ bug591033,cdzk,20201022,modify,main,main2,sub camera bring up
#if defined(WR_S5K3L6_REAR_DC_MIPI_RAW)
                        {WR_S5K3L6_REAR_DC_SENSOR_ID,
                        SENSOR_DRVNAME_WR_S5K3L6_REAR_DC_MIPI_RAW,
                        WR_S5K3L6_REAR_DC_MIPI_RAW_SensorInit},
#endif

#if defined(WR_HI1336_REAR_QH_MIPI_RAW)
                        {WR_HI1336_REAR_QH_SENSOR_ID,
                        SENSOR_DRVNAME_WR_HI1336_REAR_QH_MIPI_RAW,
                        WR_HI1336_REAR_QH_MIPI_RAW_SensorInit},
#endif

#if defined(WR_GC5035_FRONT_QH_MIPI_RAW)
                        {WR_GC5035_FRONT_QH_SENSOR_ID,
                        SENSOR_DRVNAME_WR_GC5035_FRONT_QH_MIPI_RAW,
                        WR_GC5035_FRONT_QH_MIPI_RAW_SensorInit},
#endif

#if defined(WR_HI556_FRONT_LY_MIPI_RAW)
                        {WR_HI556_FRONT_LY_SENSOR_ID,
                        SENSOR_DRVNAME_WR_HI556_FRONT_LY_MIPI_RAW,
                        WR_HI556_FRONT_LY_MIPI_RAW_SensorInit},
#endif
#if defined(WR_GC2375H_DEPTH_CXT_MIPI_RAW)
                        {WR_GC2375H_DEPTH_CXT_SENSOR_ID,
                        SENSOR_DRVNAME_WR_GC2375H_DEPTH_CXT_MIPI_RAW,
                        WR_GC2375H_DEPTH_CXT_MIPI_RAW_SensorInit},
#endif

#if defined(WR_BF2253_DEPTH_QH_MIPI_RAW)
                        {WR_BF2253_DEPTH_QH_SENSOR_ID,
                        SENSOR_DRVNAME_WR_BF2253_DEPTH_QH_MIPI_RAW,
                        WR_BF2253_DEPTH_QH_MIPI_RAW_SensorInit},
#endif
//- bug591033,cdzk,20201022,modify,main,main2,sub camera bring up
