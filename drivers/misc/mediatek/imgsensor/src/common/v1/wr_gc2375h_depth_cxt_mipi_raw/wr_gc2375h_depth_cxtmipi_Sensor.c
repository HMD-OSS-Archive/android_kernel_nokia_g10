...
#include "wr_gc2375h_depth_cxtmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "cxt_gc2375h_camera_sensor"
#define LOG_1 LOG_INF("GC2375, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#undef LOG_INF
#define CXT_GC2375H_DEBUG 0
#if CXT_GC2375H_DEBUG
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = WR_GC2375H_DEPTH_CXT_SENSOR_ID, /* record sensor id defined in Kd_imgsensor.h */
...
UINT32 WR_GC2375H_DEPTH_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
