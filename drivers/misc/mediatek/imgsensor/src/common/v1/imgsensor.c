...
#include "imgsensor.h"
//+bug594370, cdzk, add, 20201012, add factory camera info
...
//+bug584789,chenbocheng.wt,ADD,2020/10/14,add module info for mmigroup apk
#if defined(CONFIG_WT_PROJECT_T99653AA1)
		pr_info("using the t99653 camera module info for mmigroup\n");
		if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_MAIN){
			hardwareinfo_set_prop(HARDWARE_BACK_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "ronin_s5kgm1_rear_txd_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "TXD");
			else if(!strcmp(psensor_inst->psensor_name, "ronin_hi4821q_rear_st_mipi_raw"))
			...
			if(!strcmp(psensor_inst->psensor_name, "ronin_hi846_front_st_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "SHENGTAI");
			else if(!strcmp(psensor_inst->psensor_name, "ronin_gc8034_front_lh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "LHYX");
			...
			if(!strcmp(psensor_inst->psensor_name, "ronin_gc02m1b_dep_cxt_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "CXT");
			else if(!strcmp(psensor_inst->psensor_name, "ronin_bf2253_dep_lh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "LHYX");
		}else if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_SUB2){
			hardwareinfo_set_prop(HARDWARE_WIDE_ANGLE_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "ronin_hi556_wide_dc_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_WIDE_ANGLE_CAM_MOUDULE_ID, "DONGCI");
			else if(!strcmp(psensor_inst->psensor_name, "ronin_gc5035_wide_st_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_WIDE_ANGLE_CAM_MOUDULE_ID, "ST");
			...
			if(!strcmp(psensor_inst->psensor_name, "ronin_gc02m1_micro_lh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_MACRO_CAM_MOUDULE_ID, "LHYX");
			else if(!strcmp(psensor_inst->psensor_name, "ronin_gc02m1_micro_cxt_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_MACRO_CAM_MOUDULE_ID, "CXT");
		}

#elif defined(CONFIG_WT_PROJECT_T99652AA1)
		pr_info("using the t99652 camera module info for mmigroup\n");
		if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_MAIN){
			hardwareinfo_set_prop(HARDWARE_BACK_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "rogue_s5k3l6_rear_dc_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "DONGCI");
			else if(!strcmp(psensor_inst->psensor_name, "rogue_hi1336_rear_txd_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "TXD");
		}else if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_SUB){
			hardwareinfo_set_prop(HARDWARE_FRONT_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "rogue_hi846_front_st_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "SHENGTAI");
			else if(!strcmp(psensor_inst->psensor_name, "rogue_gc8034_front_lh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "LHYX");
		}else if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_MAIN2){
			hardwareinfo_set_prop(HARDWARE_BACK_SUB_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "rogue_gc02m1b_dep_cxt_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "CXT");
                        //+bug584789 zhouyikuan.wt, add, 2020/10/27,update 2nd bf2253 camera hardware info
			else if(!strcmp(psensor_inst->psensor_name, "rogue_bf2253_dep_lh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "LHYX");
		}else if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_SUB2){
			hardwareinfo_set_prop(HARDWARE_MACRO_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "rogue_gc02m1_micro_lh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_MACRO_CAM_MOUDULE_ID, "LHYX");
			else if(!strcmp(psensor_inst->psensor_name, "rogue_gc02m1_micro_cxt_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_MACRO_CAM_MOUDULE_ID, "CXT");
		}

#else
		//+bug594370, cdzk, add, 20201012, add factory camera info
		pr_info("using the t99621 camera module info for mmigroup\n");
		if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_MAIN){
			hardwareinfo_set_prop(HARDWARE_BACK_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "ironman_dongci_hi1336_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "DONGCI");
			else if(!strcmp(psensor_inst->psensor_name, "ironman_qunhui_hi1336_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "QUNHUI");
			else if(!strcmp(psensor_inst->psensor_name, "wr_s5k3l6_rear_dc_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "DONGCI");
			else if(!strcmp(psensor_inst->psensor_name, "wr_hi1336_rear_qh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "QUNHUI");

		}else if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_MAIN2){
			hardwareinfo_set_prop(HARDWARE_BACK_SUB_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "ironman_cxt_gc2375h_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "CXT");
			else if(!strcmp(psensor_inst->psensor_name, "ironman_lh_gc2375h_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "LH");
			else if(!strcmp(psensor_inst->psensor_name, "wr_gc2375h_depth_cxt_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "CXT");
			else if(!strcmp(psensor_inst->psensor_name, "wr_bf2253_depth_qh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_BACK_SUBCAM_MOUDULE_ID, "QUNHUI");

		}else if(psensor_inst->sensor_idx == IMGSENSOR_SENSOR_IDX_SUB){
			hardwareinfo_set_prop(HARDWARE_FRONT_CAM, psensor_inst->psensor_name);
			if(!strcmp(psensor_inst->psensor_name, "ironman_lianyi_gc5035_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "LIANYI");
			else if(!strcmp(psensor_inst->psensor_name, "ironman_qunhui_gc5035_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "QUNHUI");
			else if(!strcmp(psensor_inst->psensor_name, "wr_hi556_front_ly_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "LIANYI");
			else if(!strcmp(psensor_inst->psensor_name, "wr_gc5035_front_qh_mipi_raw"))
				hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "QUNHUI");
