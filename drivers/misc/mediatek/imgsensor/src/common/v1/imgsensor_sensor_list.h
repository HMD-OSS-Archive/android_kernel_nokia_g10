...
UINT32 RONIN_S5KGM1_REAR_TXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 RONIN_GC02M1_MICRO_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,chenbocheng.wt,MODIFY,2020/10/13,main s5kgm1 and depth gc02m1b sensor bringup
...
UINT32 IRONMAN_QUNHUI_HI1336_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IRONMAN_DONGCI_HI1336_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IRONMAN_LIANYI_GC5035_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IRONMAN_QUNHUI_GC5035_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IRONMAN_CXT_GC2375H_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 ROGUE_S5K3L6_REAR_DC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,zhouyikuan.wt,MODIFY,2020/10/12,rogue_dongci_s5k3l6 sensor bringup
//+bug584789,zhouyikuan.wt,MODIFY,2020/10/12,rogue_st_hi846 sensor bringup
UINT32 ROGUE_HI846_FRONT_ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,zhouyikuan.wt,MODIFY,2020/10/12,rogue_st_hi846 sensor bringup
//+bug584789,zhanghengyuan.wt,MODIFY,2020/10/14,rogue gc02m1b sensor bringup
UINT32 ROGUE_GC02M1B_DEP_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//+bug584789,zhanghengyuan.wt,MODIFY,2020/10/14,rogue gc02m1b sensor bringup
//+bug584789,zhanghengyuan.wt,MODIFY,2020/10/15,rogue micro gc02m1 sensor bringup
UINT32 ROGUE_GC02M1_MICRO_LH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ROGUE_GC02M1_MICRO_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,zhanghengyuan.wt,MODIFY,2020/10/15,rogue micro gc02m1 sensor bringup
//+bug584789,zhanghengyuan.wt,MODIFY,2020/10/21,front gc8034 and depth bf2253 sensor bringup
UINT32 ROGUE_GC8034_FRONT_LH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ROGUE_BF2253_DEP_LH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,zhanghengyuan.wt,MODIFY,2020/10/21,front gc8034 and depth bf2253 sensor bringup
//+bug584789,zhanghengyuan.wt,MODIFY,2020/10/21,rear hi1336 sensor bringup
UINT32 ROGUE_HI1336_REAR_TXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//-bug584789,zhanghengyuan.wt,MODIFY,2020/10/21,rear hi1336 sensor bringup
...
UINT32 RONIN_GC02M1_MICRO_LH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 WR_S5K3L6_REAR_DC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 WR_HI1336_REAR_QH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 WR_GC5035_FRONT_QH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 WR_HI556_FRONT_LY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 WR_GC2375H_DEPTH_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 WR_BF2253_DEPTH_QH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//- bug591033,cdzk,20201022,modify,main,main2,sub camera bring up
#if 0
/*IMX*/
