...
#include "ronin_bf2253_dep_lh_mipi_raw.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "ronin_bf2253_dep_lh_camera_sensor"
#define LOG_1 LOG_INF("RONIN_BF2253_DEP_LH, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool RONIN_BF2253_DEP_LHDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = RONIN_BF2253_DEP_LH_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x00,0x2c);//mirror on/flip on
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	RONIN_BF2253_DEP_LHDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
...
UINT32 RONIN_BF2253_DEP_LH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
