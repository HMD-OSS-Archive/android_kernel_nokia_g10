 ...
 * Filename:
 * ---------
 *     ronin_gc02m1b_dep_cxtmipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "ronin_gc02m1b_dep_cxtmipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = RONIN_GC02M1B_DEP_CXT_SENSOR_ID,
	...
	//bug596770 liuxiangyin.wt, modify, 2021/1/4/,fix 652 and 653 gc02m1b_dep_cxt camera desense RF interference
	.mclk = 26,
...
//+bug584789 chenbocheng.wt, add, 2020/10/21, first supply dualcam(s5kgm1+gc02m1b) bring up
static void set_dummy_capture(void)
{
	...
	LOG_INF("Exit! fl_lines =%d, framelength =%d\n", fl_lines,imgsensor.frame_length);
}
//-bug584789 chenbocheng.wt, add, 2020/10/21, first supply dualcam(s5kgm1+gc02m1b) bring up
				...
				kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	LOG_INF("Start! shutter1 =%d, framelength1 =%d\n", shutter,imgsensor.frame_length);
	...
	LOG_INF("Exit! shutter2 =%d, framelength2 =%d\n", shutter,imgsensor.frame_length);
...
UINT32 RONIN_GC02M1B_DEP_CXT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
